...
import { asset, legacyAsset, heroPoster } from './media'
import HeroVideo from './HeroVideo'
import DeferredLanyard from './DeferredLanyard'
...
const certificateCards = [
  ...
  ...item,
  fallbackSrc: legacyAsset(item.image.match(/assets\/.*$/)[0].replace(/\.webp$/, /ai-trainer/.test(item.image) ? '.jpg' : '.png')),
